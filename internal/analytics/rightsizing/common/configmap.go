...
func EnsureRSConfigMapExists(ctx context.Context, c client.Client, configMapName string, configNamespace string, getDefaultDataFunc func() map[string]string) error {
...
func GetRSConfigMapPredicateFunc(ctx context.Context, c client.Client, configMapName string, configNamespace string, applyChangesFunc func(context.Context, client.Client, RSNamespaceConfigMapData) error) predicate.Funcs {
	...
	return predicate.Funcs{
		CreateFunc: func(e event.CreateEvent) bool {
			if e.Object.GetName() == configMapName && e.Object.GetNamespace() == configNamespace {
		...
		UpdateFunc: func(e event.UpdateEvent) bool {
			if e.ObjectNew.GetName() != configMapName || e.ObjectNew.GetNamespace() != configNamespace {
				return true
			}
